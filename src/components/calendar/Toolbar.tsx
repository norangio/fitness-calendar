...
export function Toolbar({ title, viewMode, onViewModeChange, onPrev, onNext, onToday }: ToolbarProps) {
  return (
    <div className="flex items-center justify-between border-b border-slate-700 px-3 sm:px-5 py-2 sm:py-3">
      <div className="flex items-center gap-1 sm:gap-2">
        ...
        <h2 className="ml-1 sm:ml-2 text-sm sm:text-lg font-semibold text-slate-100">{title}</h2>
      </div>
